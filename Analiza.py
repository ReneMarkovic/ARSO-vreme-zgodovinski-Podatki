...
folder="F:/Programiranje/NapredneNumericne/Vaje/Arso_Projekt/zbrani_podatki"
for filename in os.listdir(folder):
    if filename.endswith(".csv"):
        ...
        plt.savefig(os.path.join(folder, f"{filename.replace('.csv','')}_temperature.png"),dpi=200)
        plt.clf()
        plt.close()
        """
        ########################
        ...
        ax.add_table(table)
        ax.axis("off")
        plt.savefig(os.path.join(folder, f"{filename.replace('.csv','')}_temperature_tabela.png"),dpi=200)
        plt.clf()
        plt.close
        """
      ########################
      ...
      ######################## 
        ...
        plt.savefig(os.path.join(folder, f"{filename.replace('.csv','')}_mesecne_povprecne_temperature.png"),dpi=200)
        plt.show()
        plt.close()
        """
...
plt.savefig("Korelacija_etp_Tpov.jpg",dpi=200,bbox_inches='tight')
plt.show()
plt.close() 
"""
      ########################
...
plt.savefig("Korelacija_padavine_Tpov.jpg",dpi=200,bbox_inches='tight')
plt.show()
plt.close() 
"""
